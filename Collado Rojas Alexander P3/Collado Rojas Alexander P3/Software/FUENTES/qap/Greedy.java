...
public class Greedy {
    ...
    PairGreedy<Integer, Integer>[] solucion;
    ...
    public int [] solucionGreedy(){
        ...
        this.solucion = new PairGreedy[this.tamanioMatriz];
        ...
        for(int i = 0; i < this.tamanioMatriz; i++){
            solucion[i] = new PairGreedy<>(buscarValorVector(cloneFlujo[i], this.mediaFlujo), buscarValorVector(cloneDistancia[i], this.mediaDistancia));
        }
